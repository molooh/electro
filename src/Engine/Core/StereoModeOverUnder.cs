...
{
    class StereoModeOverUnder : IStereoMode
    {
        #region Fields
        ...
        {
            get { return Stereo3DMode.OverUnder; }
        }
        ...
        public StereoModeOverUnder(Stereo3D s3d, Stereo3DMode mode, int width, int height)
        {
            _stereo3D = s3d;
            _screenWidth = width;
        ...
        {
            return 2f * _screenWidth / (float)_screenHeight;
        }
