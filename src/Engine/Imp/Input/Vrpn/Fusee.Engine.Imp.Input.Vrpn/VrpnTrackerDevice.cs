...
namespace Fusee.Engine.Imp.Input.Vrpn
{    
     /// <summary>
    ...
    public class VrpnTrackerDevice : InputDevice
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VrpnTrackerDevice"/> class.
        /// </summary>
        /// <param name="inpDeviceImp">The platform dependent connector to the underlying device.</param>
        public VrpnTrackerDevice(IInputDeviceImp inpDeviceImp) : base(inpDeviceImp)
        {
            _xVelId = RegisterVelocityAxis(0).Id;
            _yVelId = RegisterVelocityAxis(1).Id;
            _zVelId = RegisterVelocityAxis(2).Id;

            Orientation = CoordinatesystemOrientation.LeftHanded;
        }
